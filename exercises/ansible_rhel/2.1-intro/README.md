...
Let's have a first look at the Tower: Point your browser to the URL you were given, similar to `https://awx-workshop.test.icrc.org/ `  and log in as `admin`. The password will be provided by the instructor.
