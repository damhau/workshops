...
The Playbook and the role with the Jinja template already exist in the Github repository **https://github.com/damhau/workshop-examples.git** in the directory `rhel/apache`.
